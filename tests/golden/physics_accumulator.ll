...
reduce_IntegrateAndAccumulate_body:
  ...
  %"route_clamp_lo_cmp" = icmp sgt i32 %"reduce_idx", 0
  %"route_clamp_lo" = select  i1 %"route_clamp_lo_cmp", i32 %"reduce_idx", i32 0
  %"route_clamp_hi_cmp" = icmp slt i32 %"route_clamp_lo", 2047
  %"route_clamp" = select  i1 %"route_clamp_hi_cmp", i32 %"route_clamp_lo", i32 2047
  %"stream_particlesIn_byte_index" = mul i32 %"route_clamp", 4
  ...
  %".8" = bitcast i8* %"stream_particlesIn_id_byte_ptr" to i32*
  %"stream_particlesIn_val" = load i32, i32* %".8"
  %".9" = insertvalue %"struct.Particle" undef, i32 %"stream_particlesIn_val", 0
  %"stream_particlesIn_byte_index.1" = mul i32 %"route_clamp", 4
  ...
  %".10" = bitcast i8* %"stream_particlesIn_px_byte_ptr" to float*
  %"stream_particlesIn_val.1" = load float, float* %".10"
  %".11" = insertvalue %"struct.Particle" %".9", float %"stream_particlesIn_val.1", 1
  %"stream_particlesIn_byte_index.2" = mul i32 %"route_clamp", 4
  ...
  %".12" = bitcast i8* %"stream_particlesIn_py_byte_ptr" to float*
  %"stream_particlesIn_val.2" = load float, float* %".12"
  %".13" = insertvalue %"struct.Particle" %".11", float %"stream_particlesIn_val.2", 2
  %"stream_particlesIn_byte_index.3" = mul i32 %"route_clamp", 4
  ...
  %".14" = bitcast i8* %"stream_particlesIn_vx_byte_ptr" to float*
  %"stream_particlesIn_val.3" = load float, float* %".14"
  %".15" = insertvalue %"struct.Particle" %".13", float %"stream_particlesIn_val.3", 3
  %"stream_particlesIn_byte_index.4" = mul i32 %"route_clamp", 4
  ...
  %".16" = bitcast i8* %"stream_particlesIn_vy_byte_ptr" to float*
  %"stream_particlesIn_val.4" = load float, float* %".16"
  %".17" = insertvalue %"struct.Particle" %".15", float %"stream_particlesIn_val.4", 4
  %"stream_particlesIn_byte_index.5" = mul i32 %"route_clamp", 4
  ...
  %".18" = bitcast i8* %"stream_particlesIn_mass_byte_ptr" to float*
  %"stream_particlesIn_val.5" = load float, float* %".18"
  %".19" = insertvalue %"struct.Particle" %".17", float %"stream_particlesIn_val.5", 5
  %"route_clamp_lo_cmp.1" = icmp sgt i32 %"reduce_idx", 0
  %"route_clamp_lo.1" = select  i1 %"route_clamp_lo_cmp.1", i32 %"reduce_idx", i32 0
  %"route_clamp_hi_cmp.1" = icmp slt i32 %"route_clamp_lo.1", 2047
  %"route_clamp.1" = select  i1 %"route_clamp_hi_cmp.1", i32 %"route_clamp_lo.1", i32 2047
  ...
  %".20" = bitcast i8* %"stream_particlesOut_id_byte_ptr" to i32*
  %"stream_particlesOut_val" = load i32, i32* %".20"
  %".21" = insertvalue %"struct.Particle" undef, i32 %"stream_particlesOut_val", 0
  ...
  %".22" = bitcast i8* %"stream_particlesOut_px_byte_ptr" to float*
  %"stream_particlesOut_val.1" = load float, float* %".22"
  %".23" = insertvalue %"struct.Particle" %".21", float %"stream_particlesOut_val.1", 1
  ...
  %".24" = bitcast i8* %"stream_particlesOut_py_byte_ptr" to float*
  %"stream_particlesOut_val.2" = load float, float* %".24"
  %".25" = insertvalue %"struct.Particle" %".23", float %"stream_particlesOut_val.2", 2
  ...
  %".26" = bitcast i8* %"stream_particlesOut_vx_byte_ptr" to float*
  %"stream_particlesOut_val.3" = load float, float* %".26"
  %".27" = insertvalue %"struct.Particle" %".25", float %"stream_particlesOut_val.3", 3
  ...
  %".28" = bitcast i8* %"stream_particlesOut_vy_byte_ptr" to float*
  %"stream_particlesOut_val.4" = load float, float* %".28"
  %".29" = insertvalue %"struct.Particle" %".27", float %"stream_particlesOut_val.4", 4
  ...
  %".30" = bitcast i8* %"stream_particlesOut_mass_byte_ptr" to float*
  %"stream_particlesOut_val.5" = load float, float* %".30"
  %".31" = insertvalue %"struct.Particle" %".29", float %"stream_particlesOut_val.5", 5
  store %"struct.Particle" %".31", %"struct.Particle"* %"route_particlesOut_out_slot"
  call void @"shader_IntegrateAndAccumulate"(%"struct.Particle" %".19", %"struct.Particle"* %"route_particlesOut_out_slot", float* %"reduce_kineticEnergy_row")
  %"route_particlesOut_out_value" = load %"struct.Particle", %"struct.Particle"* %"route_particlesOut_out_slot"
  %".34" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 0
  ...
  %".35" = bitcast i8* %"stream_particlesOut_id_byte_ptr.1" to i32*
  store i32 %".34", i32* %".35"
  %".37" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 1
  ...
  %".38" = bitcast i8* %"stream_particlesOut_px_byte_ptr.1" to float*
  store float %".37", float* %".38"
  %".40" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 2
  ...
  %".41" = bitcast i8* %"stream_particlesOut_py_byte_ptr.1" to float*
  store float %".40", float* %".41"
  %".43" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 3
  ...
  %".44" = bitcast i8* %"stream_particlesOut_vx_byte_ptr.1" to float*
  store float %".43", float* %".44"
  %".46" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 4
  ...
  %".47" = bitcast i8* %"stream_particlesOut_vy_byte_ptr.1" to float*
  store float %".46", float* %".47"
  %".49" = extractvalue %"struct.Particle" %"route_particlesOut_out_value", 5
  ...
  %".50" = bitcast i8* %"stream_particlesOut_mass_byte_ptr.1" to float*
...
reduce_IntegrateAndAccumulate_exit:
  ...
  %".55" = bitcast i8* %"uniform_totalEnergy_value_byte_ptr" to float*
  store float %"reduce_kineticEnergy_final", float* %".55"
  ret void
}
