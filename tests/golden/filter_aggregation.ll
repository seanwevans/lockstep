...
%"struct.Lockstep_Arena" = type {[4096 x i32], [4096 x float], [4096 x i1], [4096 x i32], [4096 x float], [4096 x i1], [4096 x i32], [4096 x float], [4096 x i1], [4096 x float], float, i32, i32}
...
fused_0_exit:
  ...
  %"count_readingsAggregated_arena_bytes" = bitcast %"struct.Lockstep_Arena"* %"arena" to i8*
  %"count_readingsAggregated_value_byte_ptr" = getelementptr i8, i8* %"count_readingsAggregated_arena_bytes", i32 126984
  %".22" = bitcast i8* %"count_readingsAggregated_value_byte_ptr" to i32*
  store i32 4096, i32* %".22"
  ...
  %".24" = bitcast i8* %"uniform_grandTotal_value_byte_ptr" to float*
  store float %"fused_carry_final", float* %".24"
  ret void
}
